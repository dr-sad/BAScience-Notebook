  ...
  rightPage: {
    ...
    blocks: [
      ...
      },
      {
        ...
        officialSolution: "Grogg could revise his claim to say that for some pairs of numbers the sum is less than the product, and for other pairs the sum is greater. A counterexample shows the original claim is not always true.",
        position: {
          left: 0,
          top: 83
        },
