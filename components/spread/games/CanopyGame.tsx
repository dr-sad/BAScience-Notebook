...
export function CanopyGame() {
  ...
  useLayoutEffect(() => {
    ...
    const recomputeScale = () => {
      ...
      if (!naturalHeight || naturalHeight <= 0) return;

      const nextScale = Math.min(1, containerHeight / naturalHeight);
      setScale(nextScale);
    };
    ...
    const handleWindowResize = () => {
      // On a major resize, clear cached height so we can remeasure at scale 1.
  ...
  return (
    ...
    >
      ...
      >
        <div className="canopy-game w-full max-w-full overflow-hidden rounded border border-stone-200 bg-stone-50" ref={cardRef}>
      {/* SUNLIGHT band */}
      <div
            ...
            Array.from({ length: COLS }, (_, col) => {
              ...
              if (row < ROWS) {
                ...
                return (
                  ...
                  >
                    <button
                      type="button"
                      className={`h-[20px] w-[20px] shrink-0 rounded-full border-2 border-green-600 bg-white transition-colors focus:outline-none focus:ring-2 focus:ring-green-400${
              ...
              if (starter) {
                return (
                  ...
                  >
                    <div
                      className="h-[20px] w-[20px] shrink-0 rounded-full border-0"
                      style={{
                        backgroundColor:
              ...
              return (
                ...
                >
                  <div
                    className="h-[20px] w-[20px] shrink-0 rounded-full border-0 bg-transparent"
                    style={{
                      visibility: "hidden",
                      margin: "clamp(0.125rem, 1vw, 0.375rem)",
                    }}
        ...
        >
          ...
          {isPlacing && (
            <button
              ...
              className="rounded bg-[#36ae71] px-3 py-1 font-medium text-white shadow-md hover:bg-[#2d9660] hover:shadow-lg"
            >
              Skip
            </button>
          )}
